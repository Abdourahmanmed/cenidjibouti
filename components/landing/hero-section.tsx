    ...
    >
      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-4 sm:px-6 md:grid-cols-2 md:items-center lg:px-8">
        <div>
          ...
          <h1 className="text-balance text-4xl font-semibold tracking-tight text-secondary md:text-5xl lg:text-6xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-[#15803D]">
              <Link href="#calendrier">Consulter les informations</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="border-secondary/30 text-secondary hover:bg-[#DBEAFE]">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2">
            {heroHighlights.map((item) => (
              <article key={item.label} className="rounded-2xl border border-border bg-card p-4 shadow-[0_14px_28px_-22px_rgba(30,58,138,0.45)]">
